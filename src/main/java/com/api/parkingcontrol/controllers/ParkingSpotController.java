...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto) {
        ...
        BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel); //Conversao de parkingSpotDto para parkingSpotModel
    ...
    public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id") UUID id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Parking Spot deletes sucessfully.");
    }
    ...
    public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id, @RequestBody @Valid ParkingSpotDto parkingSpotDto) {
        ...
        if (!parkingSpotModelOptional.isPresent())
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Parking Spot ID not found.");
//        Essa parte pode ser feita de 2 formas diferentes
//        Primeira forma
        var parkingSpotModel = new ParkingSpotModel();
